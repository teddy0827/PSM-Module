...
from design_matrix import get_kmrc_design_matrices
from design_matrix import get_cpe_design_matrices

from design_matrix import DESIGN_MATRIX_FUNCTIONS
from design_matrix_config import DEFAULT_KMRC_OPTION

from design_matrix_config import DEFAULT_PSM_OPTION
from design_matrix_config import DEFAULT_CPE_OPTION
...
def multi_lot_regression_and_fitting(df_rawdata, kmrc_option=DEFAULT_KMRC_OPTION):
    # kmrc 디자인 행렬 함수 선택
    dm_func = DESIGN_MATRIX_FUNCTIONS['kmrc'][kmrc_option]
    ...
    # 15para와 19para에 따라 계수 키를 다르게 설정합니다.
    if kmrc_option == '18para':    
        dx_coeff_keys = [
...
def psm_decorrect(df_rawdata, df_psm_input, psm_option=DEFAULT_PSM_OPTION):
    """
    ...
    dm_func = DESIGN_MATRIX_FUNCTIONS['psm'][psm_option]
