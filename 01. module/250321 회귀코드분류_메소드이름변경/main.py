...
def main():
    ...
    df_coeff = multi_lot_regression_and_fitting(df_rawdata, kmrc_option=DEFAULT_KMRC_OPTION)
    ...
    df_psm_de = psm_decorrect(df_rawdata, df_psm_input, psm_option=DEFAULT_PSM_OPTION)
    ...
    df_cpe19p = resi_to_cpe(df_rawdata, cpe_option=DEFAULT_CPE_OPTION)
