...
class PlotWindow(QMainWindow):
    ...
    def update_plot(self):
        ...
        variables = [
            ...
            'residual_y_depsm', 'cpe19p_pred_x', 'cpe19p_pred_y', 'cpe19p_resi_x', 
            'cpe19p_resi_y', 'ideal_psm_x', 'ideal_psm_y', 'delta_psm_x', 'delta_psm_y'
        ]
        ...
        plot_configs = [
            ...
            {'dx': data_vars['cpe19p_pred_x'], 'dy': data_vars['cpe19p_pred_y'], 'title': 'CPE Fitting'},
            {'dx': data_vars['cpe19p_resi_x'], 'dy': data_vars['cpe19p_resi_y'], 'title': 'CPE Residual'},
